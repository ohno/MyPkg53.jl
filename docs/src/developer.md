...
If you are planning significant changes, open an [issue](https://github.com/ohno/MyPkg53.jl/issues) first. The [ColPrac](https://github.com/SciML/ColPrac) guidelines are recommended.

## One-Time Local Setup

This procedure is required only once.

1. Clone the [repository](https://github.com/ohno/MyPkg53.jl).
   ```sh
...
- [Project.toml](https://github.com/ohno/MyPkg53.jl/blob/main/Project.toml#L4)
- [CITATION.bib](https://github.com/ohno/MyPkg53.jl/blob/main/CITATION.bib#5)
